...
#ifndef BIJOU_ESPRESSO_CTRL_RUST_FREERTOSCONFIG_H
#define BIJOU_ESPRESSO_CTRL_RUST_FREERTOSCONFIG_H
...
#define configCPU_CLOCK_HZ				( 48000000UL ) // also systick runs at this frequency
...
#endif //BIJOU_ESPRESSO_CTRL_RUST_FREERTOSCONFIG_H
